...
export const SECTIONS = {
  ...
  sharedInvoices: { label: 'Factures compartides', path: '/invoices/shared' },
  conciliation: { label: 'Conciliació', path: '/conciliation' },
  fiscal: { label: 'Fiscal', path: '/fiscal' },
  ...
  accounting: { label: 'Empresa i comptabilitat', path: '/company/settings' },
  audit: { label: 'Auditoria', path: '/audit-log' },
